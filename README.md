...
- **Любая модель, есть бесплатные.** Подписка Claude, бесплатные большие модели в облаке Ollama (нужен только аккаунт), локальная Ollama (ничего не уходит в сеть), OpenRouter, DeepSeek или свой адрес. Память, навыки и записная книжка общие для всех.
...
- **Any model, free ones included:** Claude subscription, free large models in Ollama's cloud (just an account), local Ollama (nothing leaves the computer), OpenRouter, DeepSeek or any Anthropic-compatible endpoint. Memory, skills and the address book are shared across models.
