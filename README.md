...
**🎵 Свой плеер**<br>
«Включи песню…» — играет через пару секунд прямо в острове: обложка, эквалайзер, очередь; файл скачивается следом. Видео — в острове, в окне или на YouTube, как скажете.
...
**⏱ Таймеры и будильники**<br>
«Поставь таймер на 10 минут», «разбуди в 7:30 каждый день». Отсчёт виден в острове, звонок — карточка с одной кнопкой. Ставятся мгновенно, без обращения к модели.

</td>
<td valign="top">

**🗣 Голос, который не спотыкается**<br>
