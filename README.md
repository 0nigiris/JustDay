...
<p align="center">
  ...
  <a href="https://github.com/0nigiris/JustDay/actions/workflows/check.yml"><img alt="Проверка" src="https://img.shields.io/github/actions/workflow/status/0nigiris/JustDay/check.yml?style=flat-square&label=проверка"></a>
</p>
...
**🎮 Играет**<br>
Запускает игры из Steam, Heroic и других лаунчеров — по названию, как вы их зовёте.
...
**🗣️ Живой голос**<br>
Qwen3-TTS на вашей видеокарте: «Джарвис», голос по описанию или из записи. Узнаёт ваш голос и может игнорировать чужие.
...
**📱 И на телефоне**<br>
Та же просьба, тот же плеер и то же «я ушёл» — с телефона, через [телефонную половину](phone/README.md): разбудить выключенный компьютер, посмотреть загрузку, открыть терминал.

</td>
<td valign="top">

**🌅 Утренний брифинг**<br>
Первое за день «привет» — и он сразу рассказывает день: погода, ближайшая встреча, новые письма и всё, что осталось со вчера. Одной фразой, без обращения к модели.
