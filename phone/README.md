...
<p align="center">
  <img src="docs/screenshots/stage.png" alt="Стримдек: телефон, повёрнутый набок" width="760">
</p>

<p align="center"><sub>Поверните телефон — и это уже не приложение, а стримдек:
клавиши во весь экран. Снято на стенде с вымышленными машинами
(<code>tools/preview.html</code>).</sub></p>
...
| Надиктовка голосом: сказать в телефон — распознаёт домашний компьютер | готово, на телефоне ещё не проверено |
| Стримдек при повороте телефона: клавиши во весь экран | готово, на телефоне ещё не проверено |
